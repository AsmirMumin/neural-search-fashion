...
def index_from_cloud(dataset):
    """
    Pull a dataset from Jina Cloud. 
    This will be a DocumentArray with embeddings that someone has pushed there. 
    This saves you having to embed everything yourself, which is computationally expensive.
    """
